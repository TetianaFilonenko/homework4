require_relative './library/identifier.rb'
require_relative './library/published_book.rb'
require_relative './library/book.rb'
require_relative './library/reader.rb'
...
describe Library::PublishedBook do
  ...
  let!(:publisher6) { Library::PublishedBook.new '', '', '', '', '' }
...
describe Library::Reader do
  ...
  it 'should return good id of object' do
    expect(reader4.identifier).to eq 10
