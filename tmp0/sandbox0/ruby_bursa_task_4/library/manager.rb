class Library::Manager
   ...
   def new_book(_author, _title, _price, _pages_quantity, _published_at)
   end

   def new_reader(_name, _reading_speed)
   end

   def give_book_to_reader(_reader_name, _book_title)
   end

   def read_the_book(_reader_name, _duration)
   end
