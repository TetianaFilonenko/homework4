class Library::Manager
  ...
  def new_book author, title, price, pages_quantity, published_at
    book = Library::PublishedBook.new(author, title, price, pages_quantity, published_at)
  ...
  def new_reader  name, reading_speed
    reader = Library::Reader.new(name, reading_speed)
  ...
  def give_book_to_reader reader_name, book_title
    reader = Library::Reader.find readers, reader_name
    book = Library::PublishedBook.find books, book_title
    return if reader == nil || book == nil

    reader_with_book = Library::ReaderWithBook.new(book, reader)
  ...
  def read_the_book reader_name, duration
    params = Library::ReaderWithBook.find_reader_and_update_current_page(@readers_with_books, reader_name, duration)
...
TEXT
  ...
  def reader_notification_params reader_name
    params = []
    books = Library::ReaderWithBook.find_reader_with_books readers_with_books, reader_name
  ...
  def librarian_notification_params
    ...
    params << [{ published_books: @statistics["all_books"].length, 
                 ...
                 readers_reading: Library::ReaderWithBook.find_readers(readers_with_books).length }]
    readers = []
